...
Unit and integration tests are provided in the `tests/` folder.
...
Add your own test images to `tests/` and see `tests/IMAGES.md` for guidelines.
...
cv::Mat img = cv::imread("vessels.png", cv::IMREAD_GRAYSCALE);
...
2. Load a DICOM or image file.
3. Adjust processing controls and view results interactively.

---

## Screenshots

<!-- Add screenshots of the UI and output images here -->
![UI Screenshot Placeholder](docs/screenshot_placeholder.png)
